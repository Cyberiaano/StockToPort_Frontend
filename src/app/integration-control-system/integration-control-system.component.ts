...
@Component({
  selector: 'app-integrated-control-system',
  templateUrl: './integration-control-system.component.html',
  styleUrls: ['./integration-control-system.component.css']
})
export class IntegratedControlSystemComponent {
